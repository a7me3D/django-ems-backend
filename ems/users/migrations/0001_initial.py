    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('poste', models.CharField(choices=[('S', 'Salarie'), ('RI', 'Responsable Informatique'), ('RF', 'Responsable Financier'), ('RH', 'Responsable ressources Humaines')], default='S', max_length=2)),
